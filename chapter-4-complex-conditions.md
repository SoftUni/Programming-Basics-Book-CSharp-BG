...
Както видяхме в някои задачи се налага да правим много проверки наведнъж. Но какво става, когато за да изпълним някакъв код се трябва да изпълнени повече условия и не искаме да правим отрицание(else) за всяко едно от тях. Вариантът с вложените if-блокове важи, но кодът би изглеждал много неподреден и със сигурност и труден за поддръжка.  
