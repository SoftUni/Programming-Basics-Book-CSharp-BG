...
За да "обединим" примерите в един алгоритъм, ще трябва да изследваме, какво се повтаря във всеки пример. Разглеждайки тестовите примери по редове, можем да разграничим различни групи.
