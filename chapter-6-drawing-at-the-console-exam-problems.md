...
**Тялото на крепостта** се състои от начало `|`, среда " " и край `|`. **Средaта** от празно място е с големина `2 * n - 2`. Броят на **редовете** за стени, можем да определим от дадените ни примери - `n -3`

![code](/assets/chapter-6-images/fort/image-05.png)

За да нарисуваме предпоследния ред, който е част от основата, трябва да изпечатаме начало `|`, среда " " + `_` + " " и край `|`. За да направим това, можем да използваме отново вече декларираните от нас променливи `colSize` и `midSize`, защото от примерите виждаме, че са равни на `_` в покрива.
