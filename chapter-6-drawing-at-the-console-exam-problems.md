...
От примерите можем да видим структурата на началния ред. Трябва да използваме декларираните и инициализираните от нас **променливи** **`outerDots`** и **`n`**, за да изпечатаме **началния ред**.
