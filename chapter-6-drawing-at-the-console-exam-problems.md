...
![code](/assets/chapter-6-images/axe/image-01.png)
...
![code](/assets/chapter-6-images/axe/image-02.png)

За да можем да използваме отново създадените **променливи** трябва да намалим **средните тирета** с 1,а **тиретата от дясно** да увеличим с 1.

![code](/assets/chapter-6-images/axe/image-03.png)

**Дръжката на брадвата** можем да нарисуваме, като завъртим цикъл `n - 2` пъти. От примерите можем да разберем, каква е нейната структура.

![code](/assets/chapter-6-images/axe/image-04.png)

**Долната част** на фигурата, трябва да разделим на две подчасти - **глава на брадвата** и **последния ред от фигурата**. **Краят на брадвата** ще изпечатаме на конзолата като направим цикъл, който да се повтаря `n / 2 - 1` пъти. На всяка итерация **тиретата от ляво** и **тиретата от дясно** намалявт с 1, а **средните тирета** се увеличават с 2.

![code](/assets/chapter-6-images/axe/image-05.png)

За последният ред от фигурата, можем отново да използваме трите променливи `leftDashes`, `middleDashes`, `rightDashes`.

![code](/assets/chapter-6-images/axe/image-06.png)
