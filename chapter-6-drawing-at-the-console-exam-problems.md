...
Покривът се състои от две кули и междинна част, която ги свързва. Всяка кула се състои от начало **"/"**, среда **"^"** и край **"\\"**. Броят на средите "^" е равен на `n/2`.
...
<td>Използваме <b>Console.Write()</b> за да печатаме няколко пъти върху един ред.</td>
</tr></table>
...
Долните черти, които трябва да рисуваме между две кули е широчината на цялата крепост без широчината на две кули.

`Междинна част = широчината на крепост - 2*широчина на една кула`.
...
На предпоследният ред трябва да нарисуваме стена със няколко долни черти по средата. Броят им е същият като този на долните черти при покрива.

Можем да намерим интервалите на този ред:

`Брой интервали = 2*n - широчина на междинна част - 2`

Тях ще печатаме на две равни части преди и след междинната част.

<img src="assets/chapter-6-images/fort/fort-code-5.png">

Последният ред от крепоста ни, наподобява първият. Трябва да нарисуваме основи на кулите и няколко интервала между тях.
