...
### Насоки и подсказки
За да "обединим" примерите в един алгоритъм, ще трябва да изследваме, какво се повтаря във всеки пример. Разглеждайки тестовите примери по редове, можем да разграничим различни групи от редове.

![code](/assets/chapter-6-images/fort/fort-input-8-explanation.png)

Можем да разделим фигурата на 3 части:
* таван
* стени
* основа

Таванът се рисува на първия ред, а основата на последните два.
...
![code](/assets/chapter-6-images/fort/fort-roof-8-explanation.png)
...
На предпоследния ред трябва да нарисуваме ред за стена с няколко **`_`** по средата. Те са толкова колкото са долните черти при покрива.
