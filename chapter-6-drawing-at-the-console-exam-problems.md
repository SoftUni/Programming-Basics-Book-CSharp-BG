...
За да работи нашата програма правилно трябва на всяка итерация от **цикъла** да **намаляваме** броя на `_` с две.
...
Да се напише програма, която прочита от конзолата цялото нечетно число **n** и чертае вертикална стрелка, точно както в примерите.
