...
<td><strong>\</strong> е оператор за форматиране на кода и използвайки само него в Console.WriteLine(), конзолата няма да го разпечата, затова с <strong>\\</strong> показваме на конзолата, че този оператор в случая е обикновен символ.</td>
</tr></table>
