...
Нека си създадем и инициализираме нужнуте ни за логиката и изчисленията параметри.
...
Нека си създадем и инициализираме нужнуте ни за логиката и изчисленията параметри. В единият ще пазим резултатът от изчисленията, а другият ще използваме за крайният изход на програмата ни.
...
Нека си създадем и инициализираме нужнуте ни за изчисленията параметри:
