...
Разглеждайки отново условието забеляваме, че основната ни логика зависи от това какъв **месец** ни се подава, като и от броя на **нощувките**.
