...
<img src="/assets/chapter-5-exam-preparation-images/for-construction.png" max-width="800" height="275" />

**For-циклите** се състоят от:
   * 	Инициализационен блок, в който се декларира променливата-брояч `(var i)` и задаване на нейна начална стойност.
...
![code](/assets/chapter-5-exam-preparation-images/Histograma/image-01.png)
...
![code](/assets/chapter-5-exam-preparation-images/Histograma/image-02.png)

  2.    **Обработка на входните данни:** <br>
  
За да прочетем и разпределим всяко число в съответната му група, ще си послужим с **`for-цикъл`** от **0** до **n** (броя на числата).     Всяка итерация на цикъла ще прочита и разпределя **едно единствено** число (`currentNumber`) в съответната му група. За да определим   дали едно число принадлежи към дадена група, **правим проверка в съответния ѝ диапазон**. Ако това е така - увеличаваме броя на числата    в тази група (**`cntP1`**, **`cntP2`**…) с 1.  

![code](/assets/chapter-5-exam-preparation-images/Histograma/image-03.png)

<p>След като сме определили колко числа има във всяка група, можем да преминем към изчисляването на процентите, което е и главна цел на задачата. За това ще използваме следната формула:<br></p>
...
![code](/assets/chapter-5-exam-preparation-images/Histograma/image-04.png)
...
![code](/assets/chapter-5-exam-preparation-images/Histograma/image-05.png)
...
![code](/assets/chapter-5-exam-preparation-images/Histograma/image-06.png)
...
От конзолата се прочитат **3 числа**, всяко на отделен ред:<br>
...
![code](/assets/chapter-5-exam-preparation-images/Lily%20the%20Smart/image-07.png)
...
![code](/assets/chapter-5-exam-preparation-images/Lily%20the%20Smart/image-08.png)
...
![code](/assets/chapter-5-exam-preparation-images/Lily%20the%20Smart/image-09.png)
...
![code](/assets/chapter-5-exam-preparation-images/Lily%20the%20Smart/image-10.png)
...
![code](/assets/chapter-5-exam-preparation-images/Lily%20the%20Smart/image-11.png)
...
![code](/assets/chapter-5-exam-preparation-images/BackToThePast/image-12.png)
...
![code](/assets/chapter-5-exam-preparation-images/BackToThePast/image-13.png)
...
![code](/assets/chapter-5-exam-preparation-images/Hospital/image-14.png)
...
![code](/assets/chapter-5-exam-preparation-images/Hospital/image-15.png)
...
Примерни имена на променливи може да са: **`n`** – брой на числата (който трябва да прочетем от конзолата), **`divisibleBy2`**, **`divisibleBy3`**, **`divisibleBy4`** – помощни променливи, пазещи броя на числата от съответната група.
...
Декларираме си нужните променливи, например: **`countOfLoads`** – броят на товарите за превоз (прочитаме от конзолата), **`sumOfTons`** – сумата от тонажа на всички товари, **`microbus`**, **`truck`**, **`train`** – променливи, пазещи сумата от тонажа на товарите, превозвани съответно с микробус, камион и влак.
...
### Тестване в Judge системата
**`[TODO: Link to the judge to be added]`**<br>
