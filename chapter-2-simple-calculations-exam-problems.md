...
Нека пристъпим към изчисленията. Особеното тук е, че след като извършим делението, трябва да запазим в променлива само цялата част от резултата. Единият от вариантите да направим това е с метода `Math.Truncate`. Тъй като той работи с променливи от тип `double`, за броя редици и колони създаваме променливи също от този тип.  
...
Готови сме със задачата. Нека тестваме решението ѝ. 
