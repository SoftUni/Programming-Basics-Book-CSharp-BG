...
### Насоки и подсказки
Първото, което трябва да направим, е да погледнем внимателно входните данни за задачата, последователността, в която са дадени, както и да преценим какъв тип данни е уместно да използваме за всяка променлива. В конкретната задача дължината на страна от площадката, широчината и дължината на пейката са дадени като цели числа, затова е подходящо за тях да използваме тип `int`; широчината и дължината на плочките са дадени като дробни, затова за тях използваме `double`:
