...
<td><b>Търсете в Google!</b> Винаги, когато имаме идея как да решим даден проблем, но не знаем как да изпишем решението на C# или когато се сблъскаме с проблем, за който предполагаме, че много други хора са имале, най-лесният начин да се справим е да потърсим информация там. .</td>
</tr></table>

В случая можем да пробламе със следното търсене: *c# get whole number part of double number*. Откриваме, че можем да направим това с метода `Math.Truncate`. Тъй като той работи с променливи от тип `double`, за броя редици и колони създаваме променливи също от този тип.  
