...
Следва поредица от примерни задачи, решението на които ще ни помогне да разберем по-добре употребата на `while` цикъл .
...
Ето какви са нужните **стъпки**, за да може нашата програма да се изпълни коректно:
  ...
  1. В тялото на цикъла:
      1. Присвояваме нова стойност на **fact**, която е резултат от умножението на текущата стойност на **fact** и текущата стойност на **n**.
...
Ето какви са нужните **стъпки**, за да може нашата програма да се изпълни коректно:
  1. Създаваме променливата **n**, на която присвояваме въведеното от потребителят число.
