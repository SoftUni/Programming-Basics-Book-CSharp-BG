...
Безкраен цикъл наричаме този цикъл, който **повтаря безкрайно** изпълнението на тялото си. При `while` и `do...while` циклите проверката за край е условен израз, който **винаги** връща **true**. Безкраен `for` възниква, когато **липсва** параметър за **край**. 
