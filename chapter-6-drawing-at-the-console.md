...
Инициализира се цикъл с променлива `i = 1`, която ще се увеличава на всяка итерация на цикъла докато е по-малка или равна на 10 и така кодът в тялото на този цикъл ще се изпълни 10 пъти.Кода в тялото на цикъла печата на нов ред на конзолата `new string('*',10)`, което създава стринг от 10 звездички. 
