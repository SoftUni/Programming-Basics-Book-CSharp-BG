...
//TODO: Удължаване на обясненията.
...
* Въвеждаме цяло положително число `n`.
...
Напишете програма, която чете число **n** (1 ≤ n ≤ 100) и печата коледна елха с размер **n** като в примерите по-долу.
...
Напишете програма, която чете цяло число **n** (3 ≤ n ≤ 100) и печата слънчеви очила с размер  5*n x n като в примерите:
...
Напишете програма, която чете цяло число **n** и печата къщичка с размер **n x n**:
