...
Напишете програма, която въвежда число **n** и печата къщичка с размер **n x n**:
...
Да се отпечата къщичка с размери **n x n**
...
#### След като знаем условието, какъв ще решим задачата?
...
<table><tr><td><img src="/assets/alert-icon.png" style="max-width:50px" /></td>
<td>Не е добра идея да правите събирания на много на брой символни низове по показания по-горе начин. За повече информация посетете [връзката до wikipedia](https://bg.wikipedia.org/wiki/%D0%9D%D0%B8%D0%B7#String_Builder)</td>
</tr></table>
