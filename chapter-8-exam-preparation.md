...
Проверяваме дали деня не е станал по-голям от броя дни, които има в съответния месец. Ако това е така, трябва да извадим дните от месеца, от получения ден, за да получим на кой ден от следващия месец съответства.
