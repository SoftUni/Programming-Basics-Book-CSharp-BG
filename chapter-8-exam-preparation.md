...
Проверяваме дали деня не е станал по-голям от броя дни, които има в съответния месец. Ако това е така, трябва да извадим дните от месеца, от получения ден, за да получим деня от следващия месец.

![](/assets/exam-prep-1-images/exam-prep-day-of-month-4.png)

Сега трябва да увеличим и месеца, след като сме прехвърлили броя дни от предния месец. След като увеличим месеца, трябва да проверим, дали не е станал по-голям от 12. Регулираме и него по същия начин, за да получим правилния месец.

![](/assets/exam-prep-1-images/exam-prep-day-of-month-5.png)

Остава само да изкараме резултата на конзолата. Важно е да форматираме изхода правилно, за да се появява водещата нула в първите 9 месеца.
