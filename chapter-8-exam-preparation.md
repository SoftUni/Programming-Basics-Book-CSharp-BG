...
Трябва да проверим дали **сумата** на някоя двойка числа е равна на третото. Имаме три възможни случая: A + B = C , A + C = B и B + C = A. Ще си напишем **рамка**, която после ще допълним с нужния код. Ако никое от горните три условия не е изпълнено, ще зададем на програмата да принтира "No".
...
|Вход|Изход|Вход|Изход|
|---|---|---|---|
|2<br>3<br>5<br>|sum1 = 3<br>sum2 = 5<br>sum3 = 0|4<br>7<br>-2<br>6<br>|sum1 = 19<br>sum2 = -2<br>sum3 = 6|

|Вход|Изход|
|---|---|
|5<br>3<br>5<br>2<br>7<br>8|sum1 = 10<br>sum2 = 13<br>sum3 = 2| 
...
|Вход|Изход|Вход|Изход|
|---|---|---|---|
|3<br>5<br>2<br>4|2|4<br>2<br>8<br>7<br>6|2|
