 ...
 *  **`if-клауза`**
 * булев израз - променлива от булев тип (**`bool`**) или булев логически израз (израз, който връща **`true/false`**)
