...
2. Как можем да прпуснем даден символ, ако той репрезентира операция, която изисква повече пари, от колкото има Лина? С просто използване на `continue` конструкцията.
