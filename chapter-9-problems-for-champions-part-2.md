...
2. Ако нашият символ е цифра, тогава трябва да променим текущия резултат от израза в зависимост от текущия оператор, т.е. ако `expressionOperator` е `-` тогава трябва да намалим резултата с цифровата репрезентация на текущия символ. Можем да вземем цифровата репрезентация на текущия символ, чрез формулата, която използвахме при проверката на този случай ([ASCII кодът на нашия символ] - [ASCII кодът на символа `0`] = цифрата, която репрезентира символа).
...
#### Входни данни
* Входните данни трябва да се четат от конзолата.
* Входа се състои от 3 реда. Първият ред съдържа секретното число, вторият - броя бикове и третият - броя крави.
