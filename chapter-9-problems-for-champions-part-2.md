...
Проверката за крави можем да направи по следния начин:
    - Проверяваме дали първата цифра от генерираното число съвпада с втората, третата или четвъртата цифра на секретното число. Примерна имплементация:
    ![code](assets/chapter-9-2-images/03.Bulls-and-cows-10.png)

    - Проверяваме дали втората цифра от генерираното число съвпада с първата, третата или четвъртата цифра на секретното число.
    - Проверяваме дали третата цифра от генерираното число съвпада с първата, втората или четвъртата цифра на секретното число.
    - Проверяваме дали четвъртата цифра от генерираното число съвпада с първата, втората или третата цифра на секретното число.

След като приключим всички проверка, ни остава единствено да проверим дали биковете и кравите в текущото генерирано число съвпадат с желаните бикове и крави, прочетени от конзолата. Ако това е така, принтираме текущото число на конзолата.
