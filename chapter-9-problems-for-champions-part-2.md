...
# TODOs:
- Препрочитане и перифразиране на някои параграфи. В текущия си вид, звучат малко странно.
- Проверка за граматически и стилистически грешки.
- Премахване на коментарите от снимките в задача 3.
