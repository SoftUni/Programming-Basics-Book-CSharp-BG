...
Сорс кодът на програма се пише в секцията **`Main(string[] args)`**, между отварящата и затварящата скоба **`{ }`**. Това е главният метод (действие), което се изпълнява при стартиране на C# програма. Този главен метод може да се запише по два начина:
 ...
 И двата начина са валидни, като вторият е за предпочитане, защото е по-кратък и по-изчистен.
