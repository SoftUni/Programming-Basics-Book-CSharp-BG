...
<table><tr><td><img src="/assets/alert-icon.png" style="max-width:50px" />
</td><td>В програмирането не може да има два пъти оператор <code><b>return</b></code> един след друг, защото изпълнението на първия няма да позволи да се изпълни вторият. Понякога програмистите се шегуват с фразата “<b><i>напиши</i> <code>return; return;</code> <i>и да си ходим</i></b>”, с цел да обяснят, че кодът е лошо написан и най-вероятно няма да работи.</td></tr>
</table>
