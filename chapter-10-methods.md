...
**Простите** методи отговарят за изпълнението на дадено **действие**, което **спомага** за решаване на определена задача. Такива функции могат да бъдат разпечатване на даден низ на конзолата, извършване на някаква проверка, изпълнение на цикъл и т.н.
...
Няколко примера за **екоректно** наименоване на параметри:
*	`p`
*	`p1`
*	`p2`
* `populate`
