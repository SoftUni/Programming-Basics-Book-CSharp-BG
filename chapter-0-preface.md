...
**Нова група започва всеки месец**. Курсът се организира регулярно с няколко различни езика за програмиране, така че опитайте, безплатно е и може да се откажете по всяко време, ако не ви допадне. **Записването** за безплатно присъствено или онлайн обучение за стартиращи в програмирането е през **формата за кандидатстване в СофтУни**: https://softuni.bg/apply.
