...
**Всички задачи от настоящата книга са достъпни за тестване в СофтУни judge** и силно препоръчваме да ги тествате след като ги решите, за да знаете дали не изпускате нещо и дали наистина решението ви работи, според изискванията на задачата.
...
СофтУни judge системата е достъпна от [https://judge.softuni.bg](https://judge.softuni.bg). За вход използвайте автентикацията си от сайта на СофтУни [https://softuni.bg](https://softuni.bg). Убедени сме, че след няколко изпратени задачи, ще ви хареса да получавате обратна връзка дали написаното от вас решение е вярно, и judge системата ще ви стане най-любимия помощник при учене на програмирането.

### Официалeн сайт на книгата

Книгата може да бъде намерена в Интернет на адрес: [https://csharp-book.softuni.bg](https://csharp-book.softuni.bg). Това е официалният сайт на книгата и тм ще бъде качвана нейната последна версия. Книгата може да се намери и на други езици за програмиране, посочени на съответния сайт.
