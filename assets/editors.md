...
Редакторите на книгите от поредицата "Programming Basics" (Основи на програмирането) имат в предвид долу описаните условия, за да се уеднакви стилът на писане от различните авторит.
