...
Резултатът трябва да бъде принтиран на козолата, като последователни дати във __формат "дд-мм-гггг"__ подредени по азбучен ред. Всеки низ трябва да е на отделен ред. В случай че няма съществуващи магически дати, принтира "__No__".
