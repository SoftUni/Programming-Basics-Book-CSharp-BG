...
|:------:|:--------:|:------:|:------------:|
|1<br>2<br>3<br>5<br>2<br>|37|13<br>25<br>99<br>5<br>2|13|
...
В задачата имаме няколко основни момента - г**енерирането на всички комбинации** с дължина 5 включващи 5-те дадени букви, **премахването на повтарящите се букви** и **пресмятането на теглото** за дадена вече опростена дума.
...
**_Note_**: Можем да преобразуваме цифрите до букви, използвайки това, че буквите са подредени в **ASCII таблицата**. Изразът **`'а' + i`** ще ни даде резултата '**a**', ако **`i`** е равно на 0, '**c**', ако **`i`** е равно на 2 и т.н._
