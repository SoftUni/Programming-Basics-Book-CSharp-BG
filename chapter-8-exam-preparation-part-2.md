...
**Разделянето на един проблем на няколко по-лесни за решаване под-задачи е добре познатия подход „Разделяй и владей“. Усвояването му в начален стадий на обучение е от ключово значение за всички бъдещи софтуерни инженери, тъй като прилагането му ще Ви помогне да разрешите всички трудности, с които ще се сблъскате занапред.**
