...
Входът се чете от конзолата – едно **цяло числоN**в интервала \[**3**…**100**\].
...
1.	Символен низ от точки.
2.	Звезда,
3.	Символен низ от тирета.
4.	Звезда.
5.	Символен низ от тирета.
6.	Звезда.
7.	Символен низ от точки.
