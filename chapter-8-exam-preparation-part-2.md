...
1. На **първия ред** – **броя на студентите явили се на изпит** – **цяло число в интервала \[1...1000\]**
2. За **всеки един студент** на отделен ред – **оценката от изпита** – **реално число в интервала \[2.00...6.00\]**
