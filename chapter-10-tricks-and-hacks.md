...
<p>В миналата глава ви споменах, за две комбинации за форматиране на код. Едната комбинация( **bold**CTRL + K, CTRL +D**bold**) беше за **форматиране на целия код в даден файл**, а втората ( **CTRL + K , CTRL + F**) ни служеше в случай, че искаме да **форматираме само дадена част от кода**. Тези комбинации се наричат **бързи клавиши** и сега ще говорим по-подробно за тях. </p>
