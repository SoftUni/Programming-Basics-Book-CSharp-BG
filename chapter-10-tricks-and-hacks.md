...
В случай, че искаме винаги да закръгляме надолу можем вместо Math.Round() да използваме друг метод - Math.Floor(), които дори да получим число като "5.119" и искаме пак да е до втория знак то ще закръгли надолу и ще получим "5.11". Възможно е да получим и обратния ефект като за целта използваме Math.Ceiling(), който прави точно обратното - дори да получим "
