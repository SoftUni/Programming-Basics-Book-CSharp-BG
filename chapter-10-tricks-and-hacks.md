...
| Комбинация | Действие |
| :-: | :-: |
|  [**CTRL + F**] | Комбинацията **отваря търсачка**, с която можем да **търсим в нашия код**. Този бърз клавиш е широко разпространен и може да се ползва и в други среди за разработка, в сайтове и като цяло почти навсякъде. |
