...
## Настоащата книга на други програмни езици: Java, JavaScript, C++, Python, PHP

Настоящата книга е достъпна на няколко други езика за програмиране (или е в процес на адаптация за тех):
