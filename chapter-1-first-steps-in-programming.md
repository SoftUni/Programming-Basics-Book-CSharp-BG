...
Проследихме и подредбата на програмния код, като например, че командите главно се заават в секцията "static void Main(string[] args)" между отварящата и затварящата къдрава скоба.
...
Видяхме как да печатаме с: 

<pre>
Console.WriteLine(…)
</pre>

и как да стартираме програмата си с "Ctrl + F5"
