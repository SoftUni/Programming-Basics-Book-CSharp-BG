...
В настоящата глава ще разберем какво е програмирането в неговата екзистенция. Ще се запознаем и ще разберем какво са програмните езици, а също така ще разгледаме Visual Studio като среда за писане на код. Предстои да направим първата си програма на C#, а след това ще се упражним с няколко задачи (да създадем конзолна програма, графична програма или уеб приложение). Ще се научим как да проверяваме кода си в Judge системата (по-нататък ще видим какво представлява тя).
