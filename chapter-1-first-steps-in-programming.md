...
Като старт, нека първо изясним какво точно представляват **средите за разработка**, **компилаторите** и дори самите **програмни езици**.
