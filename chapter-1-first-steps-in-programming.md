...
Липсваща кавичка или липса на отваряща или затваряща скоба също може да се окаже проблем, защото както и при точката и запетаята, така и тук проблемът води до неправилно функциониране на програмата или въобще до нейното неизпълнение и трудно се забелязва при кодовете с повече редове.


## Какво научихме от тази глава?

На първо място научихме какво е програмирането - задаване на команди, изписани на компютърен език, който машината разбира и може да изпълни. 
Също така разбрахме какво е компютърната програма - поредица от команди подредени в определен ред.
Научихме се как да изпозлваме езика за програмиране C# на базисно ниво и как да създаваме прости приложения с Visual Studion.
Проследихме и подредбата на програмния код, като например, че командите главно се заават в секцията "static void Main(string[] args)" между отварящата и затварящата къдрава скоба. Видяхме как да печатаме с "Console.WriteLine()" и как да стартираме програмата си с "Ctrl + F5"
