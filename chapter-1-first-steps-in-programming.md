...
За да може да се пише на HTML (език, с който можем да правим уебсайтове), ни трябва единствено текстов редактор. Там се въвеждат самите инструкции, които впоследствие браузера разбира и "рендира". При други езици като C# или Java, освен текстов редактор, са нужни и други инструменти за създаването на програми.
