...
**Да програмираме** означава да даваме команди на компютъра какво да прави, например "да издаде звук", "да отпечата нещо на екрана" или "да умножи две числа". Когато командите са няколко една след друга, те се наричат **компютърна програма**.
...
### Езици за програмиране, компилатори, среди за разработка

Като старт, нека първо изясним какво точно представляват **средите за разработка**, **компилаторите** и **програмните езици**.

**Езикът за програмиране** е изкуствен език (синтаксис за изразяване), предназначен за **задаване на команди**, които искаме компютърът да прочете и обработи. Чрез езиците за програмиране можем да създаваме програми, които да **контролират поведението на технологичния апарат**.

**Компилаторът** превежда кода от програмен език на **машинен код**, като за всяка от конструкциите избира подходящ, предварително подготвен фрагмент от машинен код. Заедно тези фрагменти съставят програмата в машинен вид, както я очаква микропроцесорът на нашия компютър. Междувременно **текстът бива проверяван за грешки**. След това всичко се компилира и програмата се изпълнява.
