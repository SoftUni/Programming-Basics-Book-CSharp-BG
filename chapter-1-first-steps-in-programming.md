...
Езикът за програмиране е изкуствен език, предназначен за изразяване на команди, които искаме компютърът да прочете и обработи. Чрез тях можем да създаваме програми, които да контролират поведението на технологичния апарат. <br/>
Компилаторът превежда програмата от програмен език като за всяка от конструкциите избира подходящ, предварително подготвен фрагмент, на машинен език. Заедно тези фрагменти съставят програмата. Междувременно текстът бива проверяван за грешки. След това всичко се компилира и кодът се изпълнява. <br/>
